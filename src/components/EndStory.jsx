...
function EndStory({setPage}) {
  ...
  return (
    <div className='endStory'>
      ...
      המפקד שלנו יכול להגיד ביי לרבעו”ש הפעם, אבל נוכל לקוות שהוא וגם אנחנו <span className='endStory-bold'>הפקנו לקחים </span> מהסיפור הזה ובפעם הבאה נוכל לזכות ברבעו”ש המיוחל!
      </div>
